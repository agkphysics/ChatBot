...
final class DefaultResponses {
    ...
    final static String[] QUESTION_RESPONSES = { QUESTION_1, QUESTION_2, STATEMENT_1, STATEMENT_2 };

    final static String[] STATEMENT_RESPONSES = { STATEMENT_3, STATEMENT_4 };

    final static String[] FAREWELL_RESPONSES = { FAREWELL_1, FAREWELL_2 };

    /**
     * Gets a random response to a given unknown question.
     * 
     * @return a random response to a given unknown question
     */
